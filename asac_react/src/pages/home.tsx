          ...
          <div className="pt-16 pb-10 border-solid  ">
            ...
            <div className="h-14 w-96 mx-auto mt-4 2 text-center flex">
              <input
                ...
                className="h-14 w-80 rounded-xl cursor-pointer shadow-sm mt-0 bg-white mx-auto  border text-center focus:ring-1 outline-0   transition-colors"
              ></input>
              <a href="#appartements">
                <button className="h-14  bg-gradient-to-r from-indigo-500  to-indigo-700 border shadow-sm   text-neutral-50 mx-2 px-4 rounded-xl font-medium hover:scale-105 transition">
                  <div className="flex">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
